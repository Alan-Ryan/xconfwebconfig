...
- Avoid duplicating tenant-resolution logic across services.
...
4. If partnerId matches a configured alias, return mapped tenant.
5. If partnerId is present but not mapped, return partnerId itself.
6. Ensure final tenantId is never blank.

## Decision Table
| Input partnerId | Mapping match | Output tenantId |
|---|---|---|
| missing/blank | n/a | default tenant |
| partner1 | tenantA -> [partner1, partner2, partner3, partner4] | partner1 |
| partner2 | tenantA -> [partner1, partner2, partner3, partner4] | partner1 |
| partner3 | tenantA -> [partner1, partner2, partner3, partner4] | partner1 |
| partner4 | tenantA -> [partner1, partner2, partner3, partner4] | partner1 |
...
Where practical, implement a shared resolver helper used by both xconfwebconfig and xconfds device paths to reduce drift and ensure consistent behavior.
